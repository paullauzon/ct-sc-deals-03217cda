            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  buyerProfileSuggested: {
                    type: "object",
                    description: "PE buyer dossier fields inferred from the form submission, website, and external research. Leave any field as empty string when there is no evidence. Do NOT guess wildly — only fill what you can defend from the supplied sources.",
                    properties: {
                      firmAum: { type: "string", description: "Approximate assets under management or fund size, e.g. '$50M–$100M', '$1B+', or '' if unknown." },
                      acqTimeline: { type: "string", description: "One of: '0-3 months', '3-6 months', '6-12 months', '12+ months', 'Opportunistic', or '' if unknown." },
                      activeSearches: { type: "string", description: "Number or short description of concurrent acquisition searches in flight, e.g. '2 active mandates' or ''." },
                      ebitdaMin: { type: "string", description: "Lower bound of target EBITDA, e.g. '$2M', or '' if unknown." },
                      ebitdaMax: { type: "string", description: "Upper bound of target EBITDA, e.g. '$10M', or '' if unknown." },
                      dealType: { type: "string", description: "One of: 'Platform', 'Add-on / Bolt-on', 'Roll-up', 'Carve-out', 'Distressed', 'Growth', or '' if unknown." },
                      transactionType: { type: "string", description: "One of: 'Majority', 'Minority', 'Control', 'Recap', '100% Buyout', or '' if unknown." },
                      authorityConfirmed: { type: "string", description: "Yes/No/Unclear plus the decision-maker name when known, e.g. 'Yes — Managing Partner', or ''." },
                    },
                    required: ["firmAum", "acqTimeline", "activeSearches", "ebitdaMin", "ebitdaMax", "dealType", "transactionType", "authorityConfirmed"],
                    additionalProperties: false,
                  },
                },
                required: [
